...
namespace RubiksCubeLib
{
    ...
    public class CubePosition
    {
        ...
        /// </summary>
        public CubeFlag Flags => this.X | this.Y | this.Z;
    ...
    || (position == (CubeFlag.BottomLayer | CubeFlag.BackSlice | CubeFlag.RightSlice)));
        ...
        /// <param name="position">Defines the CubeFlag to be analyzed</param>
        /// <returns></returns>
        public static bool IsCenter(CubeFlag position) => ((position == (CubeFlag.TopLayer | CubeFlag.MiddleSlice | CubeFlag.MiddleSliceSides))
        ...
        /// <returns></returns>
        public bool HasFlag(CubeFlag flag) => this.Flags.HasFlag(flag);

        /// <summary>
        /// Returns the single flags in this CubeFlag
        /// </summary>
        /// <returns></returns>
        public IEnumerable<Enum> GetFlags() => CubeFlagService.GetFlags(this.Flags);
        ...
        {
            var newFlags = CubeFlagService.NextFlags(this.Flags, layer, direction);
        ...
        {
            var second = (CubePosition)obj;
            return this.X == second.X && this.Y == second.Y && this.Z == second.Z;
        }

        public override int GetHashCode() => (int)this.X + (int)this.Y + (int)this.Z;
